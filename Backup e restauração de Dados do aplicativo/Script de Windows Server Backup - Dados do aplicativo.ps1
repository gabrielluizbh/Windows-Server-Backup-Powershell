## Script de Windows Server Backup - Backup de Dados do aplicativo - Créditos Gabriel Luiz - www.gabrielluiz.com ##


$Policy = New-WBPolicy # Crie um objeto de política vazio. Variável $Policy.

Add-WBSystemState -Policy $Policy # Adiciona a política de backup a Dados do aplicativo.
