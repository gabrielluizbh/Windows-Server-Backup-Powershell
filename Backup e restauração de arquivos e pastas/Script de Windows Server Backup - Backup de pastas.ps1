## Script de Windows Server Backup - Backup de pastas - Créditos Gabriel Luiz - www.gabrielluiz.com ##


$Policy = New-WBPolicy # Crie um objeto de política vazio. Variável $Policy.

$Filespec = New-WBFileSpec -FileSpec C:\Exemplo # Especifica a pasta que será realizado o backup.
