## Script de  Windows Server Backup - Restauração de Arquivos - Créditos Gabriel Luiz - www.gabrielluiz.com ##
...
Start-WBFileRecovery -BackupSet $myBackup -SourcePath C:\Exemplo\1.bmp # Inicia o processo de restauração do arquivo.
...
Exemplo do uso do parâmetro -Option : Start-WBFileRecovery -BackupSet $myBackup -SourcePath C:\Exemplo\1.bmp -Recursive -TargetPath C:\ -Option CreateCopyIfExists
